...
public class TunerConstants {
    ...
    // https://www.robotsforroboticists.com/pid-control/ << LOOK THROUGH THIS LINK, MIGUEL!!!!
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(50).withKI(0).withKD(0.0)  // OLD : KP 100 ; KI 0; KD 0.5
        .withKS(0.1).withKV(0.0).withKA(0) // OLD : KS 0.1 ; KV 2.66 ; KA 0.0
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    private static final Slot0Configs driveGains = new Slot0Configs() 
        .withKP(0.1).withKI(0).withKD(0) // OLD : KP 0.1 ; KI 0.0 ; KD 0.0
        .withKS(0).withKV(0.124); // OLD : KS 0.0 ; KV 0.124
    ...
    private static final Distance kFrontLeftXPos = Inches.of(13.78125);
    ...
    private static final Distance kFrontRightXPos = Inches.of(13.78125);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-13.78125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.03369140625);
    private static final boolean kBackRightSteerMotorInverted = true;
    private static final boolean kBackRightEncoderInverted = false;

    private static final Distance kBackRightXPos = Inches.of(-13.78125);
